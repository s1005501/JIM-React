...
const Signin = () => {
  return (
    <div className="container Signins">
      <div className="d-flex flex-nowrap flex-column flex-lg-row row row-cols-lg-3 justify-content-center row-cols-1 my-5 Signinr">
