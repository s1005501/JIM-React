...
const StoreIndex = () => {
  return (
    <>
      ...
      <div className="d-flex flex-column flex-xxl-row justify-content-start justify-content-xxl-center align-items-xxl-start align-items-center minh storeAndMap">
        <MenuStoreVertical />
